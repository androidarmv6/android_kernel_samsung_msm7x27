...
#if defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_EUROPA)
#define MSM_FB_SIZE 		0xA0000
#elif defined(CONFIG_MACH_CALLISTO) || defined(CONFIG_MACH_LUCAS)
#define MSM_FB_SIZE 		0x11C000 // 0x500000//0x11C000	//0x5DC00
...
#else
	msm_shared_ram_phys = 0x00100000; /* Gingerbread bootloader */
#endif
	msm_map_common_io();
