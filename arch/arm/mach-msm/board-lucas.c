...
#define MSM_PMEM_ADSP_SIZE 	0x9DE000 // 0x86E000	// 3M :0x86E000, 2M : 0x77F000 
#define MSM_PMEM_AUDIO_SIZE 	0x5B000 
#define MSM_FB_SIZE 		0x11C000 // 0x500000//0x11C000	//0x5DC00 
#define PMEM_KERNEL_EBI1_SIZE 	0x1C000 
#endif	// CONFIG_MACH_LUCAS
...
#endif
#if defined(CONFIG_FB_MSM_LCDC_S6D05A0_WQVGA)
		if (!strcmp(name, "lcdc_s6d05a0_wqvga"))
			ret = 0;
		else
			ret = -ENODEV;
#endif
...
static struct i2c_board_info touch_i2c_devices[] = {
	...
	{	// Bennett 320x240 TSP  
		I2C_BOARD_INFO("synaptics-rmi-ts", 0x20/*0x2C*/),		
...
static struct i2c_board_info oj_i2c_devices[] = {
...
static struct i2c_board_info sensors_i2c_devices_new[] = {
#ifdef CONFIG_SENSORS_BMA_ACCEL
{
...
static struct i2c_gpio_platform_data sensors_i2c_gpio_data = {
	.sda_pin = 37,//GPIO_3
	.scl_pin = 36,//GPIO_2
/*	.udelay = 2,
	.sda_is_open_drain = 0,
...
static struct platform_device sensors_i2c_gpio_device = {
	.name       = "i2c-gpio",
	.id = 4,
	.dev        = {
		.platform_data = &sensors_i2c_gpio_data,
	},
};
...
#if defined(CONFIG_MACH_LUCAS) /* Atheros */
		if (gpio_get_value(BT_PWR) == 0) {
			mdelay(30);
			wlan_setup_clock(0);		
		}
...
static void __init msm7x2x_init(void)
{
	...
	if( board_hw_revision )
	{
		...
		i2c_register_board_info(4, sensors_i2c_devices_new, ARRAY_SIZE(sensors_i2c_devices_new));
	}
	else
	{
