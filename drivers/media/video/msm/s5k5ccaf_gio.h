...
#define PCAM_DEBUG(fmt, arg...)  printk("[S5K5CAGX]%s:%d:" fmt, __FUNCTION__, __LINE__, ##arg);
#else
...
s5k5ccaf_short_t s5k5ccaf_awb_ae_lock[] = 
{
{0xFCFC, 0xD000},
{0x0028, 0x7000},
{0x002A, 0x2466},
...
s5k5ccaf_short_t s5k5ccaf_awb_ae_unlock[] = 
{
{0xfcfc, 0xd000},
{0x0028, 0x7000},
{0x002A, 0x2466},
...
#define S5K5CA_INIT_REGS				(sizeof(s5k5ccaf_init0) / sizeof(s5k5ccaf_init0[0]))
#define S5K5CA_PREVIEW_REGS			(sizeof(s5k5ccaf_preview) / sizeof(s5k5ccaf_preview[0]))
#define S5K5CA_SNAPSHOT_REGS		(sizeof(s5k5ccaf_snapshot) / sizeof(s5k5ccaf_snapshot[0]))
#define S5K5CA_HIGH_SNAPSHOT_REGS	(sizeof(s5k5ccaf_high_snapshot) / sizeof(s5k5ccaf_high_snapshot[0]))
#define S5K5CA_SNAPSHOT_REGS		(sizeof(s5k5ccaf_snapshot) / sizeof(s5k5ccaf_snapshot[0]))
#define S5K5CA_LOWLIGHT_SNAPSHOT_REGS	(sizeof(s5k5ccaf_lowlight_snapshot) / sizeof(s5k5ccaf_lowlight_snapshot[0]))
#define S5K5CA_NIGHT_SNAPSHOT_REGS	(sizeof(s5k5ccaf_night_snapshot) / sizeof(s5k5ccaf_night_snapshot[0]))



#define S5K5CA_FPS_15FIX_REGS		(sizeof(s5k5ccaf_fps_15fix) / sizeof(s5k5ccaf_fps_15fix[0]))

#define S5K5CA_EFFECT_OFF_REGS		(sizeof(s5k5ccaf_effect_off) / sizeof(s5k5ccaf_effect_off[0]))
#define S5K5CA_EFFECT_MONO_REGS		(sizeof(s5k5ccaf_effect_mono) / sizeof(s5k5ccaf_effect_mono[0]))
#define S5K5CA_EFFECT_SEPIA_REGS	(sizeof(s5k5ccaf_effect_sepia) / sizeof(s5k5ccaf_effect_sepia[0]))
#define S5K5CA_EFFECT_NEGATIVE_REGS	(sizeof(s5k5ccaf_effect_negative) / sizeof(s5k5ccaf_effect_negative[0]))
#define S5K5CA_EFFECT_AQUA_REGS		(sizeof(s5k5ccaf_effect_aqua) / sizeof(s5k5ccaf_effect_aqua[0]))
#define S5K5CA_EFFECT_SKETCH_REGS	(sizeof(s5k5ccaf_effect_sketch) / sizeof(s5k5ccaf_effect_sketch[0]))


#define S5K5CA_WB_AUTO_REGS		(sizeof(s5k5ccaf_wb_auto) / sizeof(s5k5ccaf_wb_auto[0]))
#define S5K5CA_WB_DAYLIGHT_REGS		(sizeof(s5k5ccaf_wb_daylight) / sizeof(s5k5ccaf_wb_daylight[0]))
#define S5K5CA_WB_CLOUDY_REGS		(sizeof(s5k5ccaf_wb_cloudy) / sizeof(s5k5ccaf_wb_cloudy[0]))
#define S5K5CA_WB_FLUORESCENT_REGS	(sizeof(s5k5ccaf_wb_fluorescent) / sizeof(s5k5ccaf_wb_fluorescent[0]))
#define S5K5CA_WB_INCANDESCENT_REGS	(sizeof(s5k5ccaf_wb_incandescent) / sizeof(s5k5ccaf_wb_incandescent[0]))


#define S5K5CA_BRIGHTNESS_M_4_REGS	(sizeof(s5k5ccaf_brightness_m_4) / sizeof(s5k5ccaf_brightness_m_4[0]))
#define S5K5CA_BRIGHTNESS_M_3_REGS	(sizeof(s5k5ccaf_brightness_m_3) / sizeof(s5k5ccaf_brightness_m_3[0]))
#define S5K5CA_BRIGHTNESS_M_2_REGS	(sizeof(s5k5ccaf_brightness_m_2) / sizeof(s5k5ccaf_brightness_m_2[0]))
#define S5K5CA_BRIGHTNESS_M_1_REGS	(sizeof(s5k5ccaf_brightness_m_1) / sizeof(s5k5ccaf_brightness_m_1[0]))
#define S5K5CA_BRIGHTNESS_0_REGS	(sizeof(s5k5ccaf_brightness_0) / sizeof(s5k5ccaf_brightness_0[0]))
#define S5K5CA_BRIGHTNESS_P_1_REGS	(sizeof(s5k5ccaf_brightness_p_1) / sizeof(s5k5ccaf_brightness_p_1[0]))
#define S5K5CA_BRIGHTNESS_P_2_REGS	(sizeof(s5k5ccaf_brightness_p_2) / sizeof(s5k5ccaf_brightness_p_2[0]))
#define S5K5CA_BRIGHTNESS_P_3_REGS	(sizeof(s5k5ccaf_brightness_p_3) / sizeof(s5k5ccaf_brightness_p_3[0]))
#define S5K5CA_BRIGHTNESS_P_4_REGS	(sizeof(s5k5ccaf_brightness_p_4) / sizeof(s5k5ccaf_brightness_p_4[0]))



#define S5K5CA_SCENE_OFF_REGS		(sizeof(s5k5ccaf_scene_off) / sizeof(s5k5ccaf_scene_off[0]))
#define S5K5CA_SCENE_PORTRAIT_REGS	(sizeof(s5k5ccaf_scene_portrait) / sizeof(s5k5ccaf_scene_portrait[0]))
#define S5K5CA_SCENE_LANDSCAPE_REGS	(sizeof(s5k5ccaf_scene_landscape) / sizeof(s5k5ccaf_scene_landscape[0]))
#define S5K5CA_SCENE_SPORTS_REGS	(sizeof(s5k5ccaf_scene_sports) / sizeof(s5k5ccaf_scene_sports[0]))
#define S5K5CA_SCENE_PARTY_REGS		(sizeof(s5k5ccaf_scene_party) / sizeof(s5k5ccaf_scene_party[0]))
#define S5K5CA_SCENE_BEACH_REGS		(sizeof(s5k5ccaf_scene_beach) / sizeof(s5k5ccaf_scene_beach[0]))
#define S5K5CA_SCENE_SUNSET_REGS	(sizeof(s5k5ccaf_scene_sunset) / sizeof(s5k5ccaf_scene_sunset[0]))
#define S5K5CA_SCENE_DAWN_REGS		(sizeof(s5k5ccaf_scene_dawn) / sizeof(s5k5ccaf_scene_dawn[0]))
#define S5K5CA_SCENE_FALL_REGS		(sizeof(s5k5ccaf_scene_fall) / sizeof(s5k5ccaf_scene_fall[0]))
#define S5K5CA_SCENE_NIGHTSHOT_REGS	(sizeof(s5k5ccaf_scene_nightshot) / sizeof(s5k5ccaf_scene_nightshot[0]))
#define S5K5CA_SCENE_BACKLIGHT_REGS	(sizeof(s5k5ccaf_scene_backlight) / sizeof(s5k5ccaf_scene_backlight[0]))
#define S5K5CA_SCENE_FIREWORK_REGS	(sizeof(s5k5ccaf_scene_firework) / sizeof(s5k5ccaf_scene_firework[0]))
#define S5K5CA_SCENE_TEXT_REGS		(sizeof(s5k5ccaf_scene_text) / sizeof(s5k5ccaf_scene_text[0]))
#define S5K5CA_SCENE_CANDLE_REGS	(sizeof(s5k5ccaf_scene_candle) / sizeof(s5k5ccaf_scene_candle[0]))


#define S5K5CA_METERING_NORMAL_REGS	(sizeof(s5k5ccaf_metering_normal) / sizeof(s5k5ccaf_metering_normal[0]))
#define S5K5CA_METERING_SPOT_REGS	(sizeof(s5k5ccaf_metering_spot) / sizeof(s5k5ccaf_metering_spot[0]))
#define S5K5CA_METERING_CENTER_REGS	(sizeof(s5k5ccaf_metering_center) / sizeof(s5k5ccaf_metering_center[0]))


#define S5K5CA_ISO_AUTO_REGS		(sizeof(s5k5ccaf_iso_auto) / sizeof(s5k5ccaf_iso_auto[0]))
#define S5K5CA_ISO_50_REGS		(sizeof(s5k5ccaf_iso_50) / sizeof(s5k5ccaf_iso_50[0]))
#define S5K5CA_ISO_100_REGS		(sizeof(s5k5ccaf_iso_100) / sizeof(s5k5ccaf_iso_100[0]))
#define S5K5CA_ISO_200_REGS		(sizeof(s5k5ccaf_iso_200) / sizeof(s5k5ccaf_iso_200[0]))
#define S5K5CA_ISO_400_REGS		(sizeof(s5k5ccaf_iso_400) / sizeof(s5k5ccaf_iso_400[0]))


#define S5K5CA_AWB_AE_LOCK_REGS		(sizeof(s5k5ccaf_awb_ae_lock) / sizeof(s5k5ccaf_awb_ae_lock[0]))
#define S5K5CA_AWB_AE_UNLOCK_REGS	(sizeof(s5k5ccaf_awb_ae_unlock) / sizeof(s5k5ccaf_awb_ae_unlock[0]))



#define S5K5CA_AF_OFF_REGS		(sizeof(s5k5ccaf_af_off) / sizeof(s5k5ccaf_af_off[0]))
#define S5K5CA_AF_NORMAL_ON_REGS	(sizeof(s5k5ccaf_af_normal_on) / sizeof(s5k5ccaf_af_normal_on[0]))
#define S5K5CA_AF_MACRO_ON_REGS		(sizeof(s5k5ccaf_af_macro_on) / sizeof(s5k5ccaf_af_macro_on[0]))
#define S5K5CA_AF_DO_REGS		(sizeof(s5k5ccaf_af_do) / sizeof(s5k5ccaf_af_do[0]))


#define S5K5CA_CONTRAST_M_2_REGS	(sizeof(s5k5ccaf_contrast_m_2) / sizeof(s5k5ccaf_contrast_m_2[0]))
#define S5K5CA_CONTRAST_M_1_REGS	(sizeof(s5k5ccaf_contrast_m_1) / sizeof(s5k5ccaf_contrast_m_1[0]))
#define S5K5CA_CONTRAST_0_REGS		(sizeof(s5k5ccaf_contrast_0) / sizeof(s5k5ccaf_contrast_0[0]))	
#define S5K5CA_CONTRAST_P_1_REGS	(sizeof(s5k5ccaf_contrast_p_1) / sizeof(s5k5ccaf_contrast_p_1[0]))
#define S5K5CA_CONTRAST_P_2_REGS	(sizeof(s5k5ccaf_contrast_p_2) / sizeof(s5k5ccaf_contrast_p_2[0]))


#define S5K5CA_SATURATION_M_2_REGS	(sizeof(s5k5ccaf_saturation_m_2) / sizeof(s5k5ccaf_saturation_m_2[0]))
#define S5K5CA_SATURATION_M_1_REGS	(sizeof(s5k5ccaf_saturation_m_1) / sizeof(s5k5ccaf_saturation_m_1[0]))
#define S5K5CA_SATURATION_0_REGS	(sizeof(s5k5ccaf_saturation_0) / sizeof(s5k5ccaf_saturation_0[0]))
#define S5K5CA_SATURATION_P_1_REGS	(sizeof(s5k5ccaf_saturation_p_1) / sizeof(s5k5ccaf_saturation_p_1[0]))
#define S5K5CA_SATURATION_P_2_REGS	(sizeof(s5k5ccaf_saturation_p_2) / sizeof(s5k5ccaf_saturation_p_2[0]))


#define S5K5CA_SHARPNESS_M_2_REGS	(sizeof(s5k5ccaf_sharpness_m_2) / sizeof(s5k5ccaf_sharpness_m_2[0]))
#define S5K5CA_SHARPNESS_M_1_REGS	(sizeof(s5k5ccaf_sharpness_m_1) / sizeof(s5k5ccaf_sharpness_m_1[0]))
#define S5K5CA_SHARPNESS_0_REGS		(sizeof(s5k5ccaf_sharpness_0) / sizeof(s5k5ccaf_sharpness_0[0]))	
#define S5K5CA_SHARPNESS_P_1_REGS	(sizeof(s5k5ccaf_sharpness_p_1) / sizeof(s5k5ccaf_sharpness_p_1[0]))
#define S5K5CA_SHARPNESS_P_2_REGS	(sizeof(s5k5ccaf_sharpness_p_2) / sizeof(s5k5ccaf_sharpness_p_2[0]))

#define S5K5CA_DTP_ON_REGS			(sizeof(s5k5ccaf_dtp_on) / sizeof(s5k5ccaf_dtp_on[0]))
#define S5K5CA_DTP_OFF_REGS			(sizeof(s5k5ccaf_dtp_off) / sizeof(s5k5ccaf_dtp_off[0]))
