...
// defines
#define DX_MODULE_NAME 			"giouv"
#define DX_PROCFS_NAME 			"giouv"
#define DXDBG(x)					
...
// init module
static int __init giouv_init(void)
{
...
static void __exit giouv_exit(void)
{
...
module_init(giouv_init);
module_exit(giouv_exit);

MODULE_DESCRIPTION("Undervoltage module for Gio");
MODULE_LICENSE("GPL");
