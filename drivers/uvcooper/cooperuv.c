...
// defines
#define DX_MODULE_NAME 			"cooperuv"
#define DX_PROCFS_NAME 			"cooperuv"
#define DXDBG(x)					

// patch offsets

#define DEVICE_NAME				"Cooper"
...
// init module
static int __init cooperuv_init(void)
{
...
static void __exit cooperuv_exit(void)
{
...
module_init(cooperuv_init);
module_exit(cooperuv_exit);

MODULE_DESCRIPTION("Undervoltage module for Cooper");
MODULE_LICENSE("GPL");
