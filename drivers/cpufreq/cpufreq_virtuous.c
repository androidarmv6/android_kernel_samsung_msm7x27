...
this_virtuous->cur_policy->max = CONFIG_MSM_CPU_FREQ_MAX;
this_virtuous->cur_policy->min = CONFIG_MSM_CPU_FREQ_MIN;
this_virtuous->cur_policy->cur = CONFIG_MSM_CPU_FREQ_MAX;
