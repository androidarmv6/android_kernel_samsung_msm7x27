...
// defines
#define DX_MODULE_NAME 			"beniuv"
#define DX_PROCFS_NAME 			"beniuv"
#define DXDBG(x)					

// patch offsets

#define DEVICE_NAME				"Beni"
...
// init module
static int __init beniuv_init(void)
{
...
static void __exit beniuv_exit(void)
{
...
module_init(beniuv_init);
module_exit(beniuv_exit);

MODULE_DESCRIPTION("Undervoltage module for beni");
MODULE_LICENSE("GPL");
