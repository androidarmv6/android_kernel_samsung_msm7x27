...
#define MCSDL_CE_SET_HIGH()   	          		gpio_set_value(VTOUCH_EN, 1)
#define MCSDL_CE_SET_LOW()      	        		gpio_set_value(VTOUCH_EN, 0)
#define MCSDL_CE_SET_OUTPUT()   	        		gpio_tlmm_config(GPIO_CFG(VTOUCH_EN, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),GPIO_CFG_ENABLE)
#else
...
#define MCSDL_RESETB_SET_OUTPUT()           		gpio_tlmm_config(GPIO_CFG(TSP_INT, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG_ENABLE)
#define MCSDL_RESETB_SET_INPUT()            		gpio_tlmm_config(GPIO_CFG(TSP_INT, 0, GPIO_CFG_INPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_2MA),  GPIO_CFG_ENABLE)
...
#define MCSDL_GPIO_SCL_SET_OUTPUT()				gpio_tlmm_config(GPIO_CFG(TSP_SCL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),GPIO_CFG_ENABLE)
#define MCSDL_GPIO_SCL_SET_INPUT()				gpio_tlmm_config(GPIO_CFG(TSP_SCL, 0, GPIO_CFG_INPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_16MA),GPIO_CFG_ENABLE)

#define MCSDL_GPIO_SDA_SET_OUTPUT()				gpio_tlmm_config(GPIO_CFG(TSP_SDA, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_16MA),GPIO_CFG_ENABLE)
#define MCSDL_GPIO_SDA_SET_INPUT()				gpio_tlmm_config(GPIO_CFG(TSP_SDA, 0, GPIO_CFG_INPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_16MA),GPIO_CFG_ENABLE)
