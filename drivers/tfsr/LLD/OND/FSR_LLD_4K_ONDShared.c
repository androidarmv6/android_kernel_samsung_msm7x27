/**
 *   @mainpage   Flex Sector Remapper : RFS_3.0.0_b022-Nestle_1.0.0_b014-BTFS_1.0.1_b024-LinuStoreIII_1.2.0_b029-FSR_1.2.1_b125_RTM
 *
 *   @section Intro
...
{
    {{0, 0}, {FSR_LLD_SUCCESS, FSR_LLD_SUCCESS}, {FSR_4K_OND_PREOP_NONE, FSR_4K_OND_PREOP_NONE}, {FSR_4K_OND_PREOP_ADDRESS_NONE, FSR_4K_OND_PREOP_ADDRESS_NONE}, {FSR_4K_OND_PREOP_ADDRESS_NONE, FSR_4K_OND_PREOP_ADDRESS_NONE}, {FSR_LLD_FLAG_NONE, FSR_LLD_FLAG_NONE}, {0, 0},{{0,},}, {{0,},}},
    {{0, 0}, {FSR_LLD_SUCCESS, FSR_LLD_SUCCESS}, {FSR_4K_OND_PREOP_NONE, FSR_4K_OND_PREOP_NONE}, {FSR_4K_OND_PREOP_ADDRESS_NONE, FSR_4K_OND_PREOP_ADDRESS_NONE}, {FSR_4K_OND_PREOP_ADDRESS_NONE, FSR_4K_OND_PREOP_ADDRESS_NONE}, {FSR_LLD_FLAG_NONE, FSR_LLD_FLAG_NONE}, {0, 0},{{0,},}, {{0,},}},
    {{0, 0}, {FSR_LLD_SUCCESS, FSR_LLD_SUCCESS}, {FSR_4K_OND_PREOP_NONE, FSR_4K_OND_PREOP_NONE}, {FSR_4K_OND_PREOP_ADDRESS_NONE, FSR_4K_OND_PREOP_ADDRESS_NONE}, {FSR_4K_OND_PREOP_ADDRESS_NONE, FSR_4K_OND_PREOP_ADDRESS_NONE}, {FSR_LLD_FLAG_NONE, FSR_LLD_FLAG_NONE}, {0, 0},{{0,},}, {{0,},}},
    {{0, 0}, {FSR_LLD_SUCCESS, FSR_LLD_SUCCESS}, {FSR_4K_OND_PREOP_NONE, FSR_4K_OND_PREOP_NONE}, {FSR_4K_OND_PREOP_ADDRESS_NONE, FSR_4K_OND_PREOP_ADDRESS_NONE}, {FSR_4K_OND_PREOP_ADDRESS_NONE, FSR_4K_OND_PREOP_ADDRESS_NONE}, {FSR_LLD_FLAG_NONE, FSR_LLD_FLAG_NONE}, {0, 0},{{0,},}, {{0,},}}
};
